    ...
    <div>
      ...
      <Container>
        <div className="py-8 max-w-[800px] mx-auto">
          <h1 className="text-dark mb-4">Terms of Use</h1>
          ...
          <h2 className="text-dark my-8 mb-4 pb-2 border-b-2 border-border">Accounts</h2>
          <p className="mb-4">
            When you create an account with us, you must provide us with information that is accurate, complete, and current at all times. Failure to do so constitutes a breach of the Terms, which may result in immediate termination of your account on our Service.
          </p>

          <h2 className="text-dark my-8 mb-4 pb-2 border-b-2 border-border">Intellectual Property</h2>
          <p className="mb-4">
          ...
          <h2 className="text-dark my-8 mb-4 pb-2 border-b-2 border-border">Links To Other Web Sites</h2>
          <p className="mb-4">
          ...
          <h2 className="text-dark my-8 mb-4 pb-2 border-b-2 border-border">Changes</h2>
          <p className="mb-4">
